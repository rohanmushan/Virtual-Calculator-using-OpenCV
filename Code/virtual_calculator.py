...
# Updated Button Layout (% added before AC)
button_list = [
...
def detect_pinch_click(landmarks, img):
    ...
    # Get tip positions of index and middle finger
    ...
    # Detecting button press when fingers are close enough
...
# Open camera with correct window size
